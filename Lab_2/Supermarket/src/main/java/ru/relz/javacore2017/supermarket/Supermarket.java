...
import main.java.ru.relz.javacore2017.cash_desk.*;
import main.java.ru.relz.javacore2017.model.customer.*;
import main.java.ru.relz.javacore2017.database.DatabaseHelper;
import main.java.ru.relz.javacore2017.payment.Discount;
import main.java.ru.relz.javacore2017.model.product.*;
import main.java.ru.relz.javacore2017.service.ProductService;
...
public class Supermarket {
	...
	Product getProduct(Customer customer, int productId, int productAmount) {
		Product result = DatabaseHelper.getProduct(productId, productAmount);
		if (result != null) {
	...
	public void returnProductBack(Product product, Customer customer) {
		DatabaseHelper.returnBackProduct(product);
